...
def motion_detection():
    ...
    video_capture = cv2.VideoCapture("./Videos/Videos/2019-11-12 09-29 enfriamiento1.avi") # value (0) selects the devices default camera
    #time.sleep(2)
    ...
    while True:
        ...
        dilate_image = cv2.pyrDown(dilate_image)
        frame_delta = cv2.pyrDown(frame_delta)
